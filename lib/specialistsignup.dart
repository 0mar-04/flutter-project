...
class SpecialistSignUpPage extends StatefulWidget {
  @override
  _SpecialistSignUpPageState createState() => _SpecialistSignUpPageState();
}
  ...
  void _signUp() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Signed up as Specialist successfully')),
      );
              ...
              child: Column(
                children: [
                  ...
                  isLoading
                    ...
                    child: Text("Sign Up as Specialist"),
                  ),
                  SizedBox(height: 10),
                  GestureDetector(
                    onTap: () {
