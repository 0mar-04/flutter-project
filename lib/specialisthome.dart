...
import 'addpage.dart';
import 'edit_delete_service_page.dart';
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          List<Widget> serviceWidgets = snapshot.data!.docs.map((doc) {
            Map<String, dynamic> data = doc.data() as Map<String, dynamic>;
            String documentId = doc.id;
            String? serviceOwnerId = data['userId'];
              ...
              onTap: () {
                showDialog(
                  ...
                  builder: (context) => AlertDialog(
                    ...
                    actions: [
                      if (currentUser != null &&
                          currentUser.uid == serviceOwnerId) ...[
                        TextButton(
                          onPressed: () {
                            Navigator.pop(context);
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => EditDeleteServicePage(
